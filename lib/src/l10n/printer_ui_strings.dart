class PrinterUiStrings {
  ...
  static const PrinterUiStrings my = PrinterUiStrings(
    connectedTitle: 'ချိတ်ဆက်ပြီး',
    connectingTitle: 'ချိတ်ဆက်နေသည်',
    searchingPrintersTitle: 'ပရင်တာ ရှာဖွေနေသည်',
    selectPrinterTitle: 'ပရင်တာ ရွေးချယ်ပါ',
    readyToSearchTitle: 'ရှာဖွေရန် အသင့်',
    connectedSubtitle: 'ပရင်တာ အဆင်သင့်ဖြစ်ပါပြီ။',
    connectingSubtitle: 'ပရင်တာနှင့် ချိတ်ဆက်နေပါသည်။ ခဏစောင့်ပါ။',
    searchingSubtitle: 'အနီးအနား Bluetooth ပရင်တာများ ရှာဖွေနေသည်...',
    selectPrinterSubtitle: 'ချိတ်ဆက်ရန် ပရင်တာတစ်ခုကို နှိပ်ပါ။',
    readyToSearchSubtitle: 'ပရင်တာရှာရန် Start Searching ကိုနှိပ်ပါ။',
    printersFoundLabel: 'တွေ့ရှိသော ပရင်တာများ:',
    noBlePrinterFoundLabel: 'Bluetooth ပရင်တာ မတွေ့ပါ',
    startSearchingButton: 'ရှာဖွေမည်',
    stopSearchingButton: 'ရှာဖွေမှု ရပ်မည်',
    disconnectButton: 'ချိတ်ဆက်မှု ဖြုတ်မည်',
    doneButton: 'ပြီးပါပြီ',
    connectingButton: 'ချိတ်ဆက်နေသည်...',
  );
